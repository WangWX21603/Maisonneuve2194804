...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="display-one mt-3">@lang('lang.update_article')</h1>
        </div>
        <div class ="nav justify-content-end">
            <a href="{{ route('article.index') }}" class="btn btn-outline-primary btn-md mt-2">@lang('lang.return')</a>
        </div>
    </div>
    <hr>
                    ...
                    <div class="tab-content card-body" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            ...
                            <div class="control-group col-12">
                                ...
                                <textarea id="contenu" name="contenu" class="form-control" >{{ $article->contenu }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div class="control-group col-12">
                                ...
                                <input type="text" id="titre_fr" name="titre_fr" class="form-control" value="{{ $article->titre_fr }}"/>
                            </div>
                            <div class="control-group col-12">
                                <label for="contenu_fr">@lang('lang.contenu_article_fr')</label>
                                <textarea id="contenu_fr" name="contenu_fr" class="form-control">{{ $article->contenu_fr }}</textarea>
                            </div>
                        </div>
